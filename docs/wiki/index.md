...
- [2026-08-16 — Manual screenshots rebranded by repainting, not re-capture](decisions/2026-08-16-screenshot-rebrand-by-repaint.md) — 49 header lockups and 62 footer lines repainted in place at the capture pipeline's own scale; red-anchor detection needed template verification because the Reject buttons are red too. Auth headings, hero event name and demo content still stale, parked for a real re-capture
