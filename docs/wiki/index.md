...
## Decisions
- [2026-07-27 — Yang Luck is the ESA licensee; moat is the client-facing compliance clock](decisions/2026-07-27-yang-luck-licensee-positioning.md) — rivals all fight on discovery; client portal promoted from deferred to next major build; MOL 評鑑 pack + fee ledger identified as roadmap gaps
