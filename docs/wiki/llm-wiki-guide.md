...
> **Origin.** The abstract pattern is adapted from the public "LLM Wiki" idea (RAG → persistent compounding wiki). The concrete schema, stakeholder tagging, and agent workflow below were instantiated for this project; copy them into a new project and adjust the stakeholder taxonomy to fit.
