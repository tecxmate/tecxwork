...
const T: Record<Locale, Record<string, string>> = {
  zh: {
    ...
    fFeePercent: "年薪百分比",
    fFeeValue: "費率",
    fFeeValueHint: "月薪倍數請填 120 代表 1.2 個月；年薪百分比請填 20 代表 20%",
    fStatus: "狀態",
    fContactName: "聯絡人姓名",
    fTitle: "職稱",
    fEmail: "電子信箱",
  ...
  en: {
    ...
    fFeePct: "Default fee %",
    fFeeBasis: "Fee basis",
    fFeeNone: "Not agreed (enter fees manually)",
    fFeeMonths: "Multiple of monthly salary",
    fFeePercent: "Percent of first-year salary",
    fFeeValue: "Rate",
    fFeeValueHint: "120 = 1.2 months, or 20 = 20% of the first year",
    fStatus: "Status",
...
export function ClientsCrmView({ crm }: { crm: AgencyCrm }) {
  ...
  const clientFields: FieldDef[] = [
    ...
    // The rate the placement fee is computed from. Basis first, because the number is
    // meaningless without it — the old "Default fee %" field said nothing about what the
    // percentage applied to, and computed nothing.
    {
      name: "feeBasis",
      label: t.fFeeBasis,
      type: "select",
      half: true,
      options: [
        { value: "", label: t.fFeeNone },
        { value: "months_salary", label: t.fFeeMonths },
        { value: "percent_annual", label: t.fFeePercent },
      ],
    },
    {
      name: "feeValue",
