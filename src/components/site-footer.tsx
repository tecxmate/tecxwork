...
export function SiteFooter() {
  return (
    <footer className="site-footer mt-auto border-t px-4 pt-2 pb-[calc(env(safe-area-inset-bottom)+3.875rem)] text-center text-[11px] leading-tight text-muted-foreground md:pb-3 md:pt-3 md:text-xs">
