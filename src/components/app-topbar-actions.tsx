      ...
      <div className="relative md:hidden">
        ...
        {open ? (
          <>
            ...
            <div
              role="menu"
              className="absolute right-0 top-11 z-50 flex min-w-48 flex-col items-stretch gap-2 rounded-2xl border border-border bg-background p-2 text-sm shadow-xl"
            >
