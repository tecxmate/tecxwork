export const recruiterEnMessages = {
  ...
  dashboard: {
    ...
    bookings: {
      ...
      proposeTitle: "Suggest another time",
      proposeDescription: "Suggest a new time to {name}. They'll receive an email and in-app notification and can accept or decline.",
      proposeTimeLabel: "New time (Asia/Taipei)",
      proposeConfirm: "Send proposal",
      changeProposedTime: "Change time",
      retractProposal: "Retract",
    },
    applicants: {
