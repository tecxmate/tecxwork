export const recruiterZhTwMessages = {
  ...
  dashboard: {
    ...
    bookings: {
      ...
      confirmCancel: "取消面談",
      suggestTime: "建議時間",
      awaitingStudent: "等待學生回覆",
      proposeTitle: "建議其他時間",
      proposeDescription: "向 {name} 建議新的面談時間。對方會收到郵件與 App 通知，可選擇接受或拒絕。",
      proposeTimeLabel: "新時間（亞洲/台北）",
      proposeConfirm: "送出建議",
      changeProposedTime: "更改時間",
      retractProposal: "撤回建議",
    },
    applicants: {
